...
public class TotalWage {
     ...
     TotalWage(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs) {
     ...
     public static void main(String args[]) {
         ...
         TotalWage google = new TotalWage("Google", 8, 25, 130);
         TotalWage microsoft = new TotalWage("Microsoft", 8, 30, 150);
