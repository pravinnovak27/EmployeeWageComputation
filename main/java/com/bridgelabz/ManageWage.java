...
public class ManageWage {
    ...
    void CompanyEmpWageUC12(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
...
class EmployeeWageComputationUC12 implements IEmployeeWageComputationUC12
{
    ...
    // instance variables
    ArrayList<ManageWage> companies;
    ...
    public void addCompany(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
        ManageWage company = new ManageWage();
    ...
    public void calculateTotalWage()
    {
        for (ManageWage company : companies)
        {
    ...
    int calculateTotalWage(ManageWage companyEmpWage)
    {
